...
if (is_array($user) && isset($user['role']) == 'Teacher') {
    header("Location: Homepage2.php"); // Redirect teachers
    exit();
}
if (is_array($user) && isset($user['role']) == 'Student') {
    header("Location: Homepage.php"); // Redirect students
    exit();
}
...
<head>
    ...
    <title>CapEd-LMS Admin Panel</title>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link active" href="admin_student.php">Students</a></li>
                <li class="nav-item"><a class="nav-link active" href="admin_teacher.php">Teachers</a></li>
                <li class="nav-item"><a class="nav-link active" href="admin_classroom.php">Classrooms</a></li>
...
<div class="container mt-4">
    <div class="table-responsive">
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                <?php 
                $sql1 = "SELECT * FROM user_information";
                ...
                <tr>
                    ...
                    <td><!-- Optional profile pic display --></td>
